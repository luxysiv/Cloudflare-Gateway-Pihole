...
from libs import attr
from libs.multidict import CIMultiDict, CIMultiDictProxy, MultiDict, MultiDictProxy
from libs.yarl import URL
...
try:
    import libs.cchardet as chardet
except ImportError:
    import libs.charset_normalizer as chardet
